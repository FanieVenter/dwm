...
static const char *fonts[]                = { "MesloLGS Nerd Font Mono:size=13", "NotoColorEmoji:pixelsize=14:antialias=true:autohint=true"  };
...
static const int nmaster     = 6;    /* number of clients in master area */
